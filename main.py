...
ROASTS = [
    ...
    "has the confidence of someone who has never been corrected.",
    "is living proof that breathing is automatic.",
    "has the personality of a loading screen.",
    "would lose an argument with a wall.",
    "is the reason tutorials have pictures.",
    "brings nothing to the table and still asks for seconds.",
    "has Wi-Fi strength intelligence.",
    "is running on demo mode mentally.",
    "has more excuses than achievements.",
    "looks like they Google their own jokes.",
    "is the human version of a typo.",
    "talks a lot for someone who says nothing.",
    "has the awareness of a disconnected controller.",
    "is proof that evolution takes breaks.",
    "has main character confidence with background NPC impact.",
    "could trip over a wireless connection.",
    "makes silence uncomfortable just by existing.",
    "has the brainpower of a screensaver.",
    "is the reason mute buttons exist.",
    "looks like they clap when the plane lands… alone.",
    "would get lost in a straight hallway.",
    "has the energy of a dead phone at 3%.",
    "is built like a side quest nobody accepts.",
    "thinks being loud is a personality trait.",
    "has more opinions than facts.",
    "is the final boss of bad takes.",
    "could mess up a one-step tutorial.",
    "has the confidence of someone who has never checked their work.",
    "is a warning label in human form.",
    "exists entirely on vibes and zero logic.",
    "has the reaction time of expired milk.",
    "looks like they argue with customer support for fun.",
    "is the reason group projects fail.",
    "has the emotional range of a broken calculator.",
    "would miss a free throw in an empty gym.",
    "is living life on airplane mode.",
    "has the decision-making skills of a coin flip.",
    "somehow lowers the IQ of the room.",
    "is the type to forget why they opened the fridge.",
    "has the audacity but not the ability."
]
